...
--
-- Host: learning-mariadb-server    Database: rookery
-- ------------------------------------------------------
...
CREATE TABLE `bird_families` (
  ...
  `biref_description` varchar(255) COLLATE latin1_bin DEFAULT NULL,
...
INSERT INTO `birds` VALUES (1,'Charadrius vociferus','Killdeer',NULL,NULL),(2,'Gavia immer','Great Northern Loon',NULL,NULL),(3,'Aix spnnsa','Wood Duck',NULL,NULL),(4,'Chordeiles minor','Common Nighthawk',NULL,NULL),(5,'Sitta carolinensis',' White-breasted Nuthatch',NULL,NULL),(6,'Apteryx mantelli','North Island Brown Kiwi',NULL,NULL);
...
CREATE TABLE `birds_bill_shapes` (
  `bill_id` char(1) DEFAULT NULL,
  `bill_shape` char(25) DEFAULT NULL,
  `bill_example` blob DEFAULT NULL,
...
CREATE TABLE `birds_body_shapes` (
  ...
  `body_example` blob DEFAULT NULL,
...
CREATE TABLE `birds_wing_shapes` (
  ...
  `wing_example` blob DEFAULT NULL,
...
-- Dump completed on 2020-03-18  3:26:13
